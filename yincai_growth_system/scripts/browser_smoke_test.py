...
test_login_name = "browser_test_user"
test_login_secret = secrets.token_urlsafe(32)
...
environment.update({
    ...
    "ADMIN_USERNAME": test_login_name,
    "ADMIN_PASSWORD": test_login_secret,
...
try:
    ...
    with sync_playwright() as playwright:
        ...
        page.fill('input[name="username"]', test_login_name)
        page.fill('input[name="password"]', test_login_secret)
        ...
        preview_links = page.locator('a[href*="/admin/content/preview/"]')
        preview_link = preview_links.first
